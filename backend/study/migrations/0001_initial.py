    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant_count', models.CharField(choices=[('undefined', '인원 미정'), ('1', '1명'), ('2', '2명'), ('3', '3명'), ('4', '4명'), ('5', '5명'), ('6', '6명'), ('7', '7명'), ('8', '8명'), ('9', '9명'), ('10', '10명이상')], default='undefined', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='likes_user', to='user.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
